...
def convert_audio_to_text_by_google(work_path, google_bucket_name):
    ...
    audio = speech.types.RecognitionAudio(uri='gs://' + \
    ...
    metadata.interaction_type = (
        speech.enums.RecognitionMetadata.InteractionType.PRESENTATION)
    
    # Set media type
    metadata.original_media_type = (
        speech.enums.RecognitionMetadata.OriginalMediaType.VIDEO)
