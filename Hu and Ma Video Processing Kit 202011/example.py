"""
This example shows how to use interactionvideo package to process a video 
for studies in human interactions. 

If you use this package in your research,
please cite and refer to our research paper: Hu and Ma (2020), 
...
# Return a csv file of facial emotion, gender, predicted age
# Find the output
...
#     In Hu and Ma (2020), we process videos with multiple people
